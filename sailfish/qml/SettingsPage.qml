    ...
    SilicaFlickable {
        ...
        Column {
            ...
            TextField {
                ...
                placeholderText: qsTr("Enter Snips MQTT broker IP address")
                label: qsTr("Snips MQTT broker address")
            ...
            TextField {
                ...
                placeholderText: qsTr("Enter Snips MQTT broker port number")
                label: qsTr("Snips MQTT broker port")
